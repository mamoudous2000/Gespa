<?php
   ...
   //  $statement->execute()
        ...
        echo "<script type='text/javascript'> alert('PA inséré avec succes');</script>"; 
            echo "<script language='javascript'>location.href='create_action_sg.php';</script>";
        }
    }
?>
<!DOCTYPE html>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <form action='create_action_sg.php' method='post'>
                            ...
                            <div class='row clearfix'>
                                ...
                                <b>Porteur</b>
                                    <select class='form-control show-tick' name='idPorteur'>";
                                        ...
                                        echo"<option value='".$idPorteur."' >".$libporteur."</option>"; 
