...
if(isset($_POST['submit'])!=""){
 ...
 if($move){
    $query=$connect->query("insert into upload(name,fname,porteur)values('$name','$fname','DSTSI')");
    if($query){
    echo "<script language='javascript'>location.href='download_action_dstsi.php';</script>";
    ...
    <section class="content">
        <div class="container-fluid">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php
            $query=$connect->query("select * from upload where porteur='DSTSI'");
            ...
            <tr>
                ...
                <td>
                    <a href="download.php?filename=<?php echo $name;?>&f=<?php echo $row['fname'] ?>"><button type='button' class='btn bg-black waves-effect'>TELECHARGER</button></a>
                </td>
            </tr>
            <?php }?>
                                    </tbody>
