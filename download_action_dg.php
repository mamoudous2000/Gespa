...
if(isset($_POST['submit'])!=""){
 ...
 if($move){
    $query=$connect->query("insert into upload(name,fname,porteur)values('$name','$fname','DG')");
    if($query){
    echo "<script language='javascript'>location.href='download_action_dg.php';</script>";
