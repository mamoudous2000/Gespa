<?php
   ...
   //  $statement->execute()
        if($statement->execute()){ 
            ...
            echo "<script language='javascript'>location.href='create_action_dci.php';</script>";
        }
    }
?>
<!DOCTYPE html>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = 'SELECT * FROM action, porteur, source, user, pays, nature WHERE action.idporteur = porteur.idporteur and action.idpays = pays.idpays and action.idsource = source.idsource and action.iduser = user.iduser and action.idnature = nature.idnature and porteur.libporteur ="DCI"';   
                        ...
                        <form action='create_action_dci.php' method='post'>
                            ...
                            <div class='row clearfix'>
                                ...
                                <b>Porteur</b>
                                    <select class='form-control show-tick' name='idPorteur'>";
                                        $sql2 = 'SELECT * FROM porteur where idPorteur ="2"';   
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <select class="form-control show-tick" name="idPorteur">
                                        ...
                                        <?php
                                            $statement = $connect->prepare("SELECT  * FROM porteur where idPorteur ='2'");
                                            $statement->execute();
                                            $resultats=$statement->fetchAll(PDO::FETCH_ASSOC);
                                            foreach($resultats as $resultat){
