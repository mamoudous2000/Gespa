...
if(isset($_POST['submit'])!=""){
 ...
 if($move){
    $query=$connect->query("insert into upload(name,fname,porteur)values('$name','$fname','SG')");
    if($query){
    echo "<script language='javascript'>location.href='download_action_sg.php';</script>";
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php
            $query=$connect->query("select * from upload where porteur='SG'");
