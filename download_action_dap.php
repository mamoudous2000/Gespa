...
if((time() - $_SESSION['last_login_timestamp']) > 60) // 900 = 15 * 60  
      ...
      //$conn=new PDAP('mysql:host=localhost; dbname=point_daction', 'root', '') or die(mysql_error());
...
if(isset($_POST['submit'])!=""){
 ...
 if($move){
    $query=$connect->query("insert into upload(name,fname,porteur)values('$name','$fname','DAP')");
    if($query){
    echo "<script language='javascript'>location.href='DAPwnload_action_DAP.php';</script>";
    ...
    <section class="content">
        <div class="container-fluid">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php
            $query=$connect->query("select * from upload where porteur='DAP'");
            ...
            <tr>
                ...
                <td>
                    <a href="DAPwnload.php?filename=<?php echo $name;?>&f=<?php echo $row['fname'] ?>"><button type='button' class='btn bg-black waves-effect'>TELECHARGER</button></a>
                </td>
            </tr>
            <?php }?>
                                    </tbody>
        ...
        <div class="modal fade" id="ajouter" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="DAPcument">
